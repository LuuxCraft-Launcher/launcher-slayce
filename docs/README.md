...
<h1 align="center">launcher de slayce</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `Launcher-de-Slayce-win-x64.exe ` |
| macOS | `Launcher-de-Slayce-mac-universal.dmg` |
| Linux x64 | `Launcher-de-Slayce-linux-x86_64.AppImage` |
