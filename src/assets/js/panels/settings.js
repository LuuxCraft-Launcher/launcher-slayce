...
class Settings {
    ...
    async ram() {
        ...
        let memory = await window.luuxAPI.system.memory();
    ...
    async javaPath() {
        ...
        javaPathText.textContent = `${await appdata()}/${window.luuxAPI.env.platform == 'darwin' ? this.config.dataDirectory : `.${this.config.dataDirectory}`}/runtime`;
        ...
        javaPathInputFile.addEventListener("change", async () => {
            ...
            let file = window.luuxAPI.file.getPath(selectedFile);
